...
def run_plugin():
    ...
    logger.info('------------ Called Advanced Emulator Launcher Plugin: ArcadeDB Scraper ------------')
    ...
    parser = argparse.ArgumentParser(prog='script.ael.arcadedb')
    ...
    logger.debug('Advanced Emulator Launcher Plugin: ArcadeDB Scraper -> exit')
